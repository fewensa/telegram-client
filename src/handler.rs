...
impl<'a> Handler<'a> {
  ...
  pub fn handle(&self, json: &'a String) {
    ...
    match &td_type[..] {
      ...
      "updateChatIsBlocked" => event_handler!(update_chat_is_blocked, UpdateChatIsBlocked)(self.api, self.lout, json),
      ...
      "updateMessageInteractionInfo" => event_handler!(update_message_interaction_info, UpdateMessageInteractionInfo)(self.api, self.lout, json),
      "updateMessageIsPinned" => event_handler!(update_message_is_pinned, UpdateMessageIsPinned)(self.api, self.lout, json),
      ...
      "StatisticalGraph" => event_handler!(statistical_graph, StatisticalGraph)(self.api, self.lout, json),
      ...
      "countries" => event_handler!(countries, Countries)(self.api, self.lout, json),
      ...
      "messageLink" => event_handler!(message_link, MessageLink)(self.api, self.lout, json),
      "messageLinkInfo" => event_handler!(message_link_info, MessageLinkInfo)(self.api, self.lout, json),
      "messageSenders" => event_handler!(message_senders, MessageSenders)(self.api, self.lout, json),
      "messageStatistics" => event_handler!(message_statistics, MessageStatistics)(self.api, self.lout, json),
      "messageThreadInfo" => event_handler!(message_thread_info, MessageThreadInfo)(self.api, self.lout, json),
      ...
      "phoneNumberInfo" => event_handler!(phone_number_info, PhoneNumberInfo)(self.api, self.lout, json),

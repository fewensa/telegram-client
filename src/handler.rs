...
impl<'a> Handler<'a> {
  ...
  pub fn handle(&self, json: &'a String) {
    ...
    match &td_type[..] {
      ...
      "updateMessageLiveLocationViewed" => event_handler!(message_live_location_viewed, UpdateMessageLiveLocationViewed)(self.api, self.lout, json),

      "updateNewChat" => event_handler!(new_chat, UpdateNewChat)(self.api, self.lout, json),

      "updateChatChatList" => event_handler!(chat_chat_list, UpdateChatChatList)(self.api, self.lout, json),
      ...
      "updateChatHasScheduledMessages" => event_handler!(chat_has_scheduled_messages, UpdateChatHasScheduledMessages)(self.api, self.lout, json),
      ...
      "updateChatActionBar" => event_handler!(chat_action_bar, UpdateChatActionBar)(self.api, self.lout, json),
      ...
      "updateUsersNearby" => event_handler!(users_nearby, UpdateUsersNearby)(self.api, self.lout, json),

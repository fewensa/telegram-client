...
impl<'a> Handler<'a> {
  ...
  pub fn handle(&self, json: &'a String) {
    ...
    match &td_type[..] {
      ...
      "updateChatChatList" => event_handler!(update_chat_chat_list, UpdateChatChatList)(self.api, self.lout, json),
      ...
      "updateChatSource" => event_handler!(update_chat_source, UpdateChatSource)(self.api, self.lout, json),

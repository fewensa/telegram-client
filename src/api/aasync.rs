...
impl AsyncApi {
  ...
  pub async fn get_sticker_emojis<C: AsRef<GetStickerEmojis>>(&self, get_sticker_emojis: C) -> RTDResult<StickerEmojis> {
    async_caller!(StickerEmojis);
  ...
  pub async fn get_wallpapers<C: AsRef<GetWallpapers>>(&self, get_wallpapers: C) -> RTDResult<Wallpapers> {
    async_caller!(Wallpapers);
    async_caller(&self.api, get_wallpapers.as_ref()).await
  }
  ...
  pub async fn pin_supergroup_message<C: AsRef<PinSupergroupMessage>>(&self, pin_supergroup_message: C) -> RTDResult<Ok> {
    async_caller!(Ok);
    async_caller(&self.api, pin_supergroup_message.as_ref()).await
  }
  ...
  pub async fn process_dc_update<C: AsRef<ProcessDcUpdate>>(&self, process_dc_update: C) -> RTDResult<Ok> {
    async_caller!(Ok);
    async_caller(&self.api, process_dc_update.as_ref()).await
  }
  ...
  pub async fn register_device<C: AsRef<RegisterDevice>>(&self, register_device: C) -> RTDResult<Ok> {
    async_caller!(Ok);
  ...
  pub async fn set_supergroup_description<C: AsRef<SetSupergroupDescription>>(&self, set_supergroup_description: C) -> RTDResult<Ok> {
    async_caller!(Ok);
    async_caller(&self.api, set_supergroup_description.as_ref()).await
  }
  ...
  pub async fn test_use_error<C: AsRef<TestUseError>>(&self, test_use_error: C) -> RTDResult<Error> {
    async_caller!(Error);
    async_caller(&self.api, test_use_error.as_ref()).await
  }
  ...
  pub async fn toggle_basic_group_administrators<C: AsRef<ToggleBasicGroupAdministrators>>(&self, toggle_basic_group_administrators: C) -> RTDResult<Ok> {
    async_caller!(Ok);
    async_caller(&self.api, toggle_basic_group_administrators.as_ref()).await
  }
  ...
  pub async fn toggle_supergroup_invites<C: AsRef<ToggleSupergroupInvites>>(&self, toggle_supergroup_invites: C) -> RTDResult<Ok> {
    async_caller!(Ok);
    async_caller(&self.api, toggle_supergroup_invites.as_ref()).await
  }
  ...
  pub async fn unpin_supergroup_message<C: AsRef<UnpinSupergroupMessage>>(&self, unpin_supergroup_message: C) -> RTDResult<Ok> {
    async_caller!(Ok);
    async_caller(&self.api, unpin_supergroup_message.as_ref()).await
  }
